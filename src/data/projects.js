...
export const projects = [
  ...
  {
    id: 4,
    title: 'Cuadros de mando de ventas en Power BI y Tableau',
    description:
      'Informe de ventas y rentabilidad en Power BI Desktop con medidas DAX (Utilidad, Margen), limpieza de datos con Power Query y visuales por país, continente y periodo (mapa, gráficos y tarjetas KPI). Dashboard y story equivalentes construidos en Tableau y publicados en Tableau Public.',
    technologies: ['Power BI', 'DAX', 'Power Query', 'Tableau', 'Excel'],
    image: `${import.meta.env.BASE_URL}PowerBI.webp`,
    githubUrl: 'https://github.com/BorjaEscolanoMartin/powerbi-ventas-globales',
    demoUrl: 'https://public.tableau.com/app/profile/borja.escolano/viz/Supertienda-BEM/Dashboard1',
    reportUrl: 'https://github.com/BorjaEscolanoMartin/powerbi-ventas-globales/blob/main/powerbi/Appol-BEM.pdf',
    note: 'Demo: dashboard interactivo en Tableau Public · Informe (PDF): páginas del informe de Power BI',
    status: 'Completado',
    categories: ['datos-ia'],
  },
  {
    ...
    demoUrl: 'https://huggingface.co/spaces/BemDev/chatbot-rag-ut7-1',
